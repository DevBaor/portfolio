...
- **Styling**: Vanilla CSS in `src/styles.css` with CSS custom properties (`--bg`, `--surface`, `--accent`, `--line`, etc.).
- **Deployment**: Vercel SPA (configured with `vercel.json` rewrite rule).
